...
var (
	...
	ErrOldPasswordWrong    = errors.New("old password incorrect")
	ErrEmailConflict       = errors.New("email already registered, please login with password and bind this account in settings")
	ErrForcedSSO           = errors.New("this domain requires SSO login")
	ErrCaptchaRequired     = errors.New("请输入验证码")
