...
func seedServiceDefinitions(db *gorm.DB) error {
	...
	bossSerialChangeWorkflowJSON := `{"nodes":[{"id":"start","type":"start","position":{"x":400,"y":50},"data":{"label":"开始","nodeType":"start"}},{"id":"request","type":"form","position":{"x":400,"y":200},"data":{"label":"填写高风险变更协同申请","nodeType":"form","participants":[{"type":"requester"}],"formSchema":` + bossSerialChangeFormSchema + `}},{"id":"serial_review","type":"process","position":{"x":400,"y":420},"data":{"label":"总部处理人审核","nodeType":"process","participants":[{"type":"position_department","department_code":"headquarters","position_code":"serial_reviewer"}]}},{"id":"ops_process","type":"process","position":{"x":400,"y":640},"data":{"label":"信息部运维管理员处理","nodeType":"process","participants":[{"type":"position_department","department_code":"it","position_code":"ops_admin"}]}},{"id":"end","type":"end","position":{"x":400,"y":860},"data":{"label":"结束","nodeType":"end"}}],"edges":[{"id":"edge_start_request","source":"start","target":"request"},{"id":"edge_request_serial","source":"request","target":"serial_review"},{"id":"edge_serial_ops","source":"serial_review","target":"ops_process","data":{"outcome":"approved"}},{"id":"edge_serial_end","source":"serial_review","target":"end","data":{"outcome":"rejected"}},{"id":"edge_ops_end","source":"ops_process","target":"end","data":{"outcome":"approved"}},{"id":"edge_ops_end_rejected","source":"ops_process","target":"end","data":{"outcome":"rejected"}}]}`
