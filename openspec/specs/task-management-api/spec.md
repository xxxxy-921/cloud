# Capability: task-management-api

## Purpose
Provides REST API endpoints for managing and monitoring scheduler tasks, including listing tasks, viewing execution history, pausing/resuming scheduled tasks, and manually triggering executions.
