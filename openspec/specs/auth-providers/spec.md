...
## Purpose
OAuth authentication provider management system supporting third-party login (GitHub, Google), user-provider bindings, OAuth flow handling (authorization, callback, token exchange), and admin configuration of provider credentials.
