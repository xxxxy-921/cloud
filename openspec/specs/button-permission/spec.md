# Capability: button-permission

## Purpose
Provides frontend button-level permission control, including the usePermission hook, PermissionGuard component, and conditional rendering of action buttons based on the user's menu permissions.
