# Capability: i18n-backend

## Purpose
Provides backend internationalization support including structured error keys, go-i18n integration for notification/email translation, and App-level locale file extension.
