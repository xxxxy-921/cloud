# Capability: ldap-auth

## Purpose
LDAP bind authentication flow within the identity App, providing password-based external authentication, JIT user provisioning, TLS support, attribute mapping, and connection lifecycle management.
