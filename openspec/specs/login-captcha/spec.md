# Capability: login-captcha

## Purpose
Captcha system for login protection, supporting image-based captcha generation, verification, and integration with the login flow.
...
- **THEN** the system SHALL return 400 with message "captcha incorrect"
