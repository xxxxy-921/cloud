# Capability: login-lockout

## Purpose
Account lockout mechanism to protect against brute-force login attacks by tracking failed attempts and temporarily locking accounts.
...
- **THEN** the system SHALL return 423 with message "account locked, please try again in N minutes" where N is the remaining lockout minutes, WITHOUT verifying the password
