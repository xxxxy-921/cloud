...
## Purpose
Provides a notification system with data model, APIs for listing/reading/counting notifications, a unified send interface for other modules, and a frontend notification bell with popover UI.
