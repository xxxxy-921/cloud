# Capability: license-edition

## Purpose
Provides build-time configuration for the license management product edition, including Go build file and Makefile release target.
