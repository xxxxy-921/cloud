# Capability: message-channel

## Purpose
Provides message channel management for the system, enabling configuration and testing of notification delivery channels (e.g., email via SMTP). Includes a driver abstraction for extensibility and a frontend management page.
