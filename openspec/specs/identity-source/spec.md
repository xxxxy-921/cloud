...
## Purpose
Identity source management for the identity App, providing CRUD operations for OIDC and LDAP identity sources with encrypted sensitive fields, domain binding, and connectivity testing.
