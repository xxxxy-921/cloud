# Capability: license-plan

## Purpose
License plan management backend capability. Provides CRUD operations for plans (bound to products), default plan management, ConstraintValues validation against product ConstraintSchema, and REST API routes nested under product routes in the license App.
