# Capability: task-management-ui

## Purpose
Provides the frontend pages for viewing and managing scheduler tasks, including a task list with statistics dashboard, action buttons with permission guards, and a task detail page with execution history.
