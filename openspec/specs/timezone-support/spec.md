# Capability: timezone-support

## Purpose
Provides timezone handling across backend and frontend, ensuring all database timestamps remain in UTC while the frontend formats times according to user/system timezone preferences using IANA identifiers.
