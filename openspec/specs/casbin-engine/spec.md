# Capability: casbin-engine

## Purpose
Provides the Casbin RBAC authorization engine, including model definition, GORM adapter persistence, IOC registration, middleware enforcement, and a high-level service API for policy management.
