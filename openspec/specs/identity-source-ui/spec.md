# Capability: identity-source-ui

## Purpose
Frontend management interface for identity sources within the identity App, providing list view, create/edit forms with type-specific configuration fields, and toggle/test/delete actions.
