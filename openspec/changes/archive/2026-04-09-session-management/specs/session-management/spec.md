...
The system SHALL enforce a configurable maximum number of concurrent sessions per user. The limit is read from SystemConfig key `security.max_concurrent_sessions` (default: 5, 0 means unlimited).
